...
namespace Ellucian.Ethos.Integration.Config.Test
{
    public class EthosConfigurationClientTest
    {
        ...
        public EthosConfigurationClientTest()
        {
            ...
            resWithFiltersAndNamedQueries =
                SampleTestDataRepository.GetAvailableResourcesWithFiltersAndNamedQueriesData();
        }
...
""");
            ...
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAvailableResources());
...
""");
        ...
        public void FilterAvailableResource_ByName()
        {
            ...
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAvailableResourcesForFilterAvailableResources());
        ...
        [Fact]
        public async Task GetFiltersAndNamedQueriesAsync_ResourceName_Null_Excpection()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await client.GetFiltersAndNamedQueriesAsync("", ""));
        }
        ...
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAvailableResourcesWithFiltersAndNamedQueriesData());
        ...
        public async Task GetNamedQueriesAsync_Version()
        {
            ...
            var actual =
                await client.GetNamedQueriesAsync("persons", "application/vnd.hedtech.integration.v12.1.0+json");
            Assert.NotNull(actual);
            _ = Assert.IsAssignableFrom<Dictionary<string, IEnumerable<string>>>(actual);
        }

        [Fact]
        public async Task GetVersionHeadersForAppAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () => await client.GetVersionHeadersForAppAsync(""));
        }
        ...
        [Fact]
        public async Task GetVersionsForAppAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () => await client.GetVersionsForAppAsync(""));
        }
        ...
        [Fact]
        public async Task GetMajorVersionsOfResourceAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () => await client.GetMajorVersionsOfResourceAsync(""));
        }
        ...
        [Fact]
        public async Task IsResourceVersionSupportedAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () => await client.IsResourceVersionSupportedAsync(""));
        }
        ...
        public async Task IsResourceVersionSupportedAsync_FullHeader_True()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAvailableResources());
            var actual =
                await client.IsResourceVersionSupportedAsync("address-types",
        ...
        public async Task IsResourceVersionSupportedAsync_FullHeader_False()
        {
            ...
            var actual =
                await client.IsResourceVersionSupportedAsync("address-types",
                    "application/vnd.hedtech.integration.vBad+json");
            Assert.False(actual);
        }

        [Fact]
        public async Task IsResourceVersionSupportedAsync_FullHeader_EmptyResourceName_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await client.IsResourceVersionSupportedAsync("", "application/vnd.hedtech.integration.v6+json"));
        }

        [Fact]
        public async Task IsResourceVersionSupportedAsync_FullHeader_EmptyFullVersioHeader_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () =>
        ...
        [Fact]
        public async Task GetVersionHeadersOfResourceAsStringsAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await client.GetVersionHeadersOfResourceAsStringsAsync("      "));
        }
        ...
        [Fact]
        public async Task GetVersionHeadersOfResourceAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await client.GetVersionHeadersOfResourceAsync("      "));
        }
        ...
        [Fact]
        public async Task GetVersionHeaderAsync_ArgumentNullException()
        {
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAppConfigFilterAvailableResources());
            _ = await Assert.ThrowsAsync<ArgumentNullException>(async () => await client.GetVersionHeaderAsync("      "));
        }
        ...
        [Fact]
        public async Task GetVersionHeaderAsync_Match_UnsupportedVersionException()
        {
            SemVer semVer = new SemVer() { Major = 6, Minor = -1, Patch = -2 };
            client = new EthosConfigurationClient(SampleTestDataRepository.API_KEY,
                SampleTestDataRepository.GetMockAvailableResources());
            _ = await Assert.ThrowsAsync<UnsupportedVersionException>(async () =>
                await client.GetVersionHeaderAsync("address-types", semVer));
        }
